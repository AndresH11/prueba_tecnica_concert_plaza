...
export const NotFound = () => (
	<div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
		<div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
			...
			<NavLink
				className="flex items-center space-x-2 bg-blueDark max-w-fit rounded-md text-center text-white text-sm font-bold p-2 transition-transform hover:scale-105"
				replace
				title="Ir al home"
				to={PATH_PREFIX_HOME}>
				<svg
		...
		<div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
			<svg
				...
				<circle cx="212.59226" cy="103" fill="#ff6584" r="64"></circle>
				<path
					...
					fill="#cbd5e1"
					transform="translate(-39.70387 -61.04208)"></path>
				<polygon
					fill="#3f3d56"
					points="316.156 523.761 318.21 397.378 403.674 241.024 318.532 377.552 319.455 320.725 378.357 207.605 319.699 305.687 319.699 305.687 321.359 203.481 384.433 113.423 321.621 187.409 322.658 0 316.138 248.096 316.674 237.861 252.547 139.704 315.646 257.508 309.671 371.654 309.493 368.625 235.565 265.329 309.269 379.328 308.522 393.603 308.388 393.818 308.449 394.99 293.29 684.589 313.544 684.589 315.974 535.005 389.496 421.285 316.156 523.761"></polygon>
				<path
				...
				<polygon
					fill="#3f3d56"
					points="950.482 552.833 952.162 449.383 1022.119 321.4 952.426 433.154 953.182 386.639 1001.396 294.044 953.382 374.329 953.382 374.329 954.741 290.669 1006.369 216.952 954.954 277.514 955.804 124.11 950.467 327.188 950.906 318.811 898.414 238.464 950.064 334.893 945.173 428.327 945.027 425.847 884.514 341.294 944.844 434.608 944.232 446.293 944.123 446.469 944.173 447.428 931.764 684.478 948.343 684.478 950.332 562.037 1010.514 468.952 950.482 552.833"></polygon>
				<ellipse
					cx="554.59226"
					cy="680.47903"
					fill="#3f3d56"
				...
				<ellipse
					...
					rx="217.01436"
					ry="10.96996"></ellipse>
				<circle cx="97.08375" cy="566.26982" fill="#2f2e41" r="79"></circle>
				<rect
					fill="#2f2e41"
					height="43"
				...
				<ellipse
					...
					rx="7.5"
					ry="20"
					transform="translate(-654.1319 782.47948) rotate(-89.32491)"></ellipse>
				<ellipse
					cx="167.55414"
					cy="732.18168"
					fill="#2f2e41"
					rx="7.5"
					ry="20"
					transform="translate(-606.25475 830.05533) rotate(-89.32491)"></ellipse>
				<circle cx="99.31925" cy="546.29477" fill="#fff" r="27"></circle>
				<circle cx="99.31925" cy="546.29477" fill="#3f3d56" r="9"></circle>
				<path
				...
				<path
					...
					fill="#3f3d56"
					transform="translate(-39.70387 -61.04208)"></path>
				<circle cx="712.48505" cy="565.41532" fill="#2f2e41" r="79"></circle>
				<rect
					fill="#2f2e41"
					height="43"
				...
				<ellipse
					...
					rx="20"
					ry="7.5"
					transform="translate(-220.8593 196.83312) rotate(-17.08345)"></ellipse>
				<ellipse
					cx="813.47537"
					cy="716.94619"
					fill="#2f2e41"
					rx="20"
					ry="7.5"
					transform="translate(-214.42477 209.56103) rotate(-17.08345)"></ellipse>
				<circle cx="708.52153" cy="545.71023" fill="#fff" r="27"></circle>
				<circle cx="708.52153" cy="545.71023" fill="#3f3d56" r="9"></circle>
				<path
				...
				<ellipse
					...
					rx="12.40027"
					ry="39.5"
					transform="translate(-220.83517 966.22323) rotate(-64.62574)"></ellipse>
				<ellipse
					cx="112.51694"
					cy="651.82212"
					fill="#2f2e41"
					rx="12.40027"
					ry="39.5"
					transform="translate(-574.07936 452.71367) rotate(-68.15829)"></ellipse>
			</svg>
		</div>
	</div>
)
